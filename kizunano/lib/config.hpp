...
enum class nano_networks
{
	...
	nano_test_network = 0,
	kizunano_test_network = 0,
	// Normal work parameters, secret beta genesis key, beta IP ports
	nano_beta_network = 1,
	kizunano_beta_network = 1,
	// Normal work parameters, secret live key, live IP ports
	nano_live_network = 2,
	kizunano_live_network = 2,
};
...
public:
	...
	publish_thresholds (is_live_network () ? publish_test : is_beta_network () ? publish_beta : publish_test)
	{
		// A representative is classified as principal based on its weight and this factor
		principal_weight_factor = 1000; // 0.1%

		default_node_port = is_live_network () ? 3975 : is_beta_network () ? 54000 : 44000;
		default_rpc_port = is_live_network () ? 3976 : is_beta_network () ? 55000 : 45000;
		default_ipc_port = is_live_network () ? 3977 : is_beta_network () ? 56000 : 46000;
		default_websocket_port = is_live_network () ? 3978 : is_beta_network () ? 57000 : 47000;
