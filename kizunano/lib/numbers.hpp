...
// SI dividers
nano::uint128_t const total_supply = nano::uint128_t ("20000000000000000");
nano::uint128_t const Gxrb_ratio = nano::uint128_t ("1000000000"); // 10^9
nano::uint128_t const Mxrb_ratio = nano::uint128_t ("1000000"); // 10^6
nano::uint128_t const kxrb_ratio = nano::uint128_t ("1000"); // 10^3
nano::uint128_t const xrb_ratio = nano::uint128_t ("1"); // 10^0
