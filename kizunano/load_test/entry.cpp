#include <kizunano/boost/asio/bind_executor.hpp>
#include <kizunano/boost/asio/connect.hpp>
#include <kizunano/boost/beast/core/flat_buffer.hpp>
#include <kizunano/boost/beast/http.hpp>
...
int main (int argc, char * const * argv)
{
	...
	description.add_options ()
		...
		("node_path", boost::program_options::value<std::string> (), "The path to the kizunano_node to test")
		("rpc_path", boost::program_options::value<std::string> (), "The path to the kizunano_rpc to test");
	// clang-format on
	...
	{
		auto node_filepath = running_executable_filepath.parent_path () / "kizunano_node";
	...
	{
		std::cerr << "kizunano_node executable could not be found in " << node_path << std::endl;
		return 1;
	}
	...
	{
		auto rpc_filepath = running_executable_filepath.parent_path () / "kizunano_rpc";
		if (running_executable_filepath.has_extension ())
		{
	...
	{
		std::cerr << "kizunano_rpc executable could not be found in " << rpc_path << std::endl;
		return 1;
	}
