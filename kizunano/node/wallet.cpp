...
#include <kizunano/node/lmdb/lmdb_iterator.hpp>
...
nano::uint128_t const nano::wallets::generate_priority = nano::total_supply;
nano::uint128_t const nano::wallets::high_priority = nano::total_supply - 1;
