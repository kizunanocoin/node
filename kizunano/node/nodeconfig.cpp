...
#include <kizunano/lib/config.hpp>
...
const char * default_beta_peer_network = "peering-beta.kizunanocoin.com";
const char * default_live_peer_network = "peering.kizunanocoin.com";
}
...
external_address (boost::asio::ip::address_v6{}.to_string ())
{
	...
	switch (network_params.network.network ())
	{
		...
		case nano::nano_networks::nano_beta_network:
		{
			...
			release_assert (!offline_representative.decode_account ("kizn_1kn1h953om6c39i1k96heo3ym46o65o19hh9h6wet3zxajur4u1gjoof5ca3"));
...
nano::error nano::node_config::serialize_toml (nano::tomlconfig & toml) const
{
	...
	toml.put ("online_weight_quorum", online_weight_quorum, "Percentage of votes required to confirm blocks. A value below 10 is not recommended.\ntype:uint64");
	...
	toml.put ("bootstrap_connections", bootstrap_connections, "Number of outbound bootstrap connections. Must be a power of 2. Defaults to 2.\nWarning: a larger amount of connections may use substantially more system memory.\ntype:uint64");
