...
#include <kizunano/lib/json_error_response.hpp>
#include <kizunano/lib/timer.hpp>
#include <kizunano/node/bootstrap/bootstrap_lazy.hpp>
#include <kizunano/node/common.hpp>
#include <kizunano/node/election.hpp>
#include <kizunano/node/json_handler.hpp>
#include <kizunano/node/json_payment_observer.hpp>
...
void nano::json_handler::version ()
{
	...
	response_l.put ("node_vendor", boost::str (boost::format ("KIZN %1%") % NANO_VERSION_STRING));
