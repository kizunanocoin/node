...
#include <kizunano/lib/diagnosticsconfig.hpp>
#include <kizunano/lib/errors.hpp>
#include <kizunano/lib/jsonconfig.hpp>
#include <kizunano/lib/lmdbconfig.hpp>
#include <kizunano/lib/numbers.hpp>
#include <kizunano/lib/rocksdbconfig.hpp>
#include <kizunano/lib/stats.hpp>
#include <kizunano/node/ipc/ipc_config.hpp>
#include <kizunano/node/logging.hpp>
#include <kizunano/node/websocketconfig.hpp>
...
public:
	...
	std::vector<std::pair<std::string, uint16_t>> secondary_work_peers{ { "127.0.0.1", 4976 } }; /* Default of nano-pow-server */
	...
	nano::amount online_weight_minimum{ nano::Mxrb_ratio };
	unsigned online_weight_quorum{ 10 };
	...
	unsigned bootstrap_connections{ 2 };
	...
	std::string external_address{ "::ffff:0.0.0.0" };
	...
	size_t active_elections_size{ 251 };
	...
	nano::frontiers_confirmation_mode frontiers_confirmation{ nano::frontiers_confirmation_mode::disabled };
