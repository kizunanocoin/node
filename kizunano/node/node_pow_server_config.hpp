...
inline std::string get_default_pow_server_filepath ()
{
	...
	// Construct the kizunano_pow_server executable file path based on where the currently running executable is found.
	auto pow_server_filepath = running_executable_filepath.parent_path () / "kizunano_pow_server";
